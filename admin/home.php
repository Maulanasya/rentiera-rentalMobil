                    ...
                    <div class="card-body p-4 d-flex flex-column">
                        ...
                        <div class="d-flex gap-2 mt-auto">
                            ...
                            <a href="../config/aksi_mobil.php?aksi=hapus&id=<?php echo $data['id_mobil']; ?>"
                                ...
                                onclick="return confirm('Yakin ingin menghapus mobil <?php echo $data['merk']; ?>?')">
                                <i class="bi bi-trash"></i> Hapus
                            </a>
                        </div>

                        <div class="modal fade" id="modalEdit<?php echo $data['id_mobil']; ?>" tabindex="-1"
                            aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content rounded-4 border-0 shadow">
                                    ...
                                    <form action="../config/aksi_mobil.php?aksi=edit" method="POST"
                                        ...
                                        <div class="modal-footer border-0">
                                            <button type="submit"
                                                class="btn btn-dark w-100 rounded-pill py-3 fw-bold">SIMPAN
                                                PERUBAHAN</button>
                                        </div>
                                    </form>
                                </div>
